...
class _RegistrationPage2State extends State<RegistrationPage2> {
  ...
  Widget build(BuildContext context) {
    List<String> maritalOptions = [
      translation(context).unmarried,
      translation(context).married,
      translation(context).widow
    ];
    List<String> casteOptions = [
      translation(context).general,
      translation(context).obc,
      translation(context).sCaste,
      translation(context).sTribe
    ];
    List<String> educationalOptions = [
      translation(context).below10,
      translation(context).tenth,
      translation(context).twelth,
      translation(context).graduate,
      translation(context).postGraduate,
      translation(context).doctorate
    ];
    return Consumer<FormProvider>(
      builder: (context, formProvider, _) => Form(
        //key: _formKey,
